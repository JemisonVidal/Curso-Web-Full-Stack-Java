...
public class PessoaJuridica {
	...
	public PessoaJuridica(int id, String nome, String endereco, String cnpj, String email, int setor, Date dataDeAdimissao,
			Date dataDeDemissao, Date dataUltimaFerias, Double salarioBase, PessoaCargo cargo) {
		super();
		this.id = id;
		this.nome = nome;
	...
	public void solicitarFerias() {
		...
		int numeroDeMesesAdmissao = (int) ((dataAtual.getTime() - this.dataDeAdmissao.getTime())
				/ MES_EM_MILISEGUNDOS);
		...
		if (isApproved) setDataUltimaFerias(dataAtual);
	}

	public void demitir(PessoaJuridica funcionario) {
	...
	public void reajustarSalario(PessoaJuridica funcionario, float porcentagem) {
		if (porcentagem <= 0)
